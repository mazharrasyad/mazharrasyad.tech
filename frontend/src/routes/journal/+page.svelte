<script lang="ts">
	...
	import type { ScholarData } from '$lib/types';
			...
			{#each publications as pub (pub.url)}
				<div class="card-glass rounded-2xl p-4 md:p-5">
					<div class="flex items-center gap-2 mb-1.5 flex-wrap">
						...
						<span class="bg-white/5 text-slate-300 text-xs px-2 py-0.5 rounded-full font-bold border border-white/10 tabular-nums">
							{pub.year}
						</span>
