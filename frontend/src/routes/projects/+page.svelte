<script lang="ts">
	...
	const description = `${totalProjects}+ software projects by Muhammad Azhar Rasyad, grouped by where they came from: Company, Freelance, Organization, Research, Campus, Diklat and Learning.`;
