...
- **Frontend:** [SvelteKit](https://kit.svelte.dev) (Svelte 5, TypeScript, Tailwind CSS v4), prerendered to static HTML via `adapter-static`. Project archive lives in `frontend/src/lib/data/projects.json` and is rendered dynamically per year at `/projects/[year]`.
